...
export const seedObjectSnapshotable = (): Omit<BattleSnapshot, 'battleHash'> => ({
    "time": 1593079336988, "launchTime": -1, "charactersSnapshots": [ {
    ...
    } ], "spellsSnapshots": [
        {
            ...
            "staticData": { "id": "s1", "name": "name", "description": "", "role": "move", "initialFeatures": { "rangeArea": -1, "attack": 10, "duration": 300 } }, "index": 1, "features": { "rangeArea": -1, "attack": 10, "duration": 300 }
        }, {
            "id": "s2", "characterId": "c1",
            "staticData": { "id": "s2", "name": "name", "description": "", "role": "simpleAttack", "initialFeatures": { "rangeArea": 8, "attack": 20, "duration": 1000 } }, "index": 2, "features": { "rangeArea": 8, "attack": 20, "duration": 1000 }
        }, {
            "id": "s3", "characterId": "c2",
            "staticData": { "id": "s3", "name": "name", "description": "", "role": "move", "initialFeatures": { "rangeArea": -1, "attack": 10, "duration": 600 } }, "index": 1, "features": { "rangeArea": -1, "attack": 10, "duration": 600 }
        }, {
            "id": "s4", "characterId": "c2",
            "staticData": { "id": "s4", "name": "name", "description": "", "role": "simpleAttack", "initialFeatures": { "rangeArea": 5, "attack": 40, "duration": 1500 } }, "index": 1, "features": { "rangeArea": 5, "attack": 40, "duration": 1500 }
        } ]
});
